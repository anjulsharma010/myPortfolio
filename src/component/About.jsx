...
import resumePdf from "../assets/mpResume.pdf";
      ...
      <div className="tracking-widest w-[100%] mx-auto flex py-4 pl-[8%] pr-[8%]">
        <div className="flex flex-col items-center mbTb:items-top mbTb:flex-row mbTb:gap-[5%] xl:gap-[15%]">
          <div className=" mbTb:w-[50%] pt-[50px] pr-[12%]">
            ...
            <h1 className="text-5xl font-bold py-2">Anjul Sharma</h1>
            <h2 className="text-[#c5ba22] text-2xl font-semibold">
              FRONTEND DEVELOPER
            </h2>
            <p className="text-[#c3c3c3]">
              Experience - Mito Infotech <i className="text-[10px]">(May-2023 to Present)</i>
            </p>
            <p className="text-[#9e9e9e] text-[13px] py-2">
              Skilled react.js developer with 1.5 years Of hands-on experience.
              Expertise in building responsive and scalable web applications.
              Strong frontend development and UI/UX design.
            </p>
            <p className="text-[#c3c3c3]">Open for work and collaborations.</p>

            <div className="my-8">
              <a href={resumePdf} target="_blank">
                <button className="downloadResumeBtn flex items-center gap-3 rounded-full px-10 py-2">
                  <img
                    className="downloadResumeBtnImg w-9"
          ...
          <div className="myImageDiv mbTb:w-[50%] pt-[30px] lg:pr-[80px]">
            <img
              className="myImage w-[70%] mx-auto"
              src={myImage}
              alt="my Image"
              ref={myImageRef}
        ...
        <div className="flex flex-col items-center gap-6 mt-6 fixed right-4 mbTb:right-7">
          ...
          <div className="flex flex-col gap-3">
            <a
              href="https://www.linkedin.com/in/anjul-sharma-916509220/"
              target="_blank"
            ...
            <a
              href="https://github.com/anjulsharma010"
              target="_blank"
              className="aboutSocialIconsDiv bg-[#c5ba22] rounded-full inline-block p-2 w-10"
            >
              <img
